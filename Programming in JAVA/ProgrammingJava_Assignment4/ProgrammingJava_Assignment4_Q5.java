   ...
   public static void main(String[] args)
   {
	   ...
	   int bRate = input.nextInt();
		...
		if ((aPop <= bPop) && (aRate >= bRate))
		{
			...
			System.out.println("After "+year+" year(s) the population of town A will be greater than or\nequal to the population of town B.");
			System.out.println("After "+year+" population of town A is "+(int)aPopFur);
			System.out.println("After "+year+" population of town B is "+(int)bPopFur);
		}
		else
